...
def main(args):
    ...
    # Improves inference speed (for torch versions above 2.0)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate images from an image prompt using SDXL 1.0.")
    parser.add_argument("--prompt", type=str, required=True, help="Prompt for image generation")
    parser.add_argument("--init-image-path", type=str, required=True, help="Path of image for img2img generation")
    parser.add_argument("--output-path", type=str, default="outputs/sdxl/img2img/", help="Output path for saving generated images (default: 'outputs/sdxl/img2img/')")
    parser.add_argument("--strength", type=float, default=0.5, help="Strength for image generation, a float between 0.0 and 1.0 (default: 0.5)")    # parser.add_argument("--n-steps", type=int, default=40, help="Number of steps for image generation (default: 40)")
    # parser.add_argument("--high-noise-frac", type=float, default=0.8, help="High noise fraction for image generation (default: 0.8)")
    parser.add_argument("--log-path", type=str, default="logs/sdxl_img2img_log.txt", help="Output path for the log file (default: 'logs/sdxl_img2img_log.txt')")
